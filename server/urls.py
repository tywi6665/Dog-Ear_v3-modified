...
urlpatterns += [
    ...
    path("activate/.*$/.*$/", never_cache(FrontendAppView.as_view())),
    path("resend_activation/", never_cache(FrontendAppView.as_view())),
    path("reset_password/.*$/.*$/", never_cache(FrontendAppView.as_view())),
    ...
    path("catalog/recipe/.*$/", never_cache(FrontendAppView.as_view())),
    path("catalog/recipe/.*$/edit/", never_cache(FrontendAppView.as_view())),
    path(r'', never_cache(FrontendAppView.as_view()), name='index'),
    re_path(r"^(?:.*)?$", never_cache(FrontendAppView.as_view())),
]
